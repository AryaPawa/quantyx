...
class BlackScholesCall :
    ...
    def call_delta (self , asset_price, asset_volatility, strike_price,
    ...
    def call_gamma(self , asset_price, asset_volatility, strike_price,
                    time_to_expiration, risk_free_rate
                    ):
         b = math.exp(-risk_free_rate * time_to_expiration)
         x1 = math.log(asset_price / (strike_price)) + .5 * (asset_volatility*asset_volatility) * time_to_expiration
    ...
    def call_vega(self , asset_price, asset_volatility, strike_price,
                    time_to_expiration, risk_free_rate
                    ):
        b = math.exp(-risk_free_rate*time_to_expiration)
        x1 = math.log(asset_price/(strike_price)) + .5*(asset_volatility*asset_volatility)*time_to_expiration
    ...
    def call_theta(self , asset_price, asset_volatility, strike_price,
                    time_to_expiration, risk_free_rate
                    ):
         x1 = math.log(asset_price/(strike_price)) + .5*(asset_volatility*asset_volatility)*time_to_expiration
         x1 = x1/(asset_volatility*(time_to_expiration**.5))
    ...
    def __inti__(self , asset_price, asset_volatility, strike_price,
                 time_to_expiration , risk_free_rate
                    ) :
...
class BlackScholesPut : 
    ...
    def put_delta(self ,asset_price, asset_volatility, strike_price,
                  time_to_expiration, risk_free_rate
                  ) :
        b = math.exp(-risk_free_rate*time_to_expiration)
        x1 = math.log(asset_price / (strike_price)) + .5*(asset_volatility*asset_volatility)*time_to_expiration
